...
**Использование:** Этот интерфейс предназначен для панелей, которые должны получать все клавиатурные вводные данные, минуя стандартную систему фокуса (например, терминал, редактор кода); метод `WantsRawKeys()` служит индикатором намерения панели.
